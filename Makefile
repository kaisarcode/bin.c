## Makefile
## Summary: Cross-compilation builder for bin.
##
## Author:  KaisarCode
...
define linux_target
	...
	@cp $(BUILD_DIR)/$(subst /,-,$(1))-linux/out/bin $(BIN_DIR)/$(1)/linux/bin
	@echo "OK $(1)/linux"
endef
...
define windows_target
	...
	@cp $(BUILD_DIR)/$(1)-windows/out/bin.exe $(BIN_DIR)/$(1)/windows/bin.exe
	@echo "OK $(1)/windows"
endef
...
define android_target
	...
	@cp $(BUILD_DIR)/$(1)-android/out/bin $(BIN_DIR)/$(1)/android/bin
	@echo "OK $(1)/android"
endef
